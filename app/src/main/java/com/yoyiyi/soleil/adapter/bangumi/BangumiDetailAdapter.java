        ...
        switch (mulBangumiDetail.itemType) {
            ...
            case MulBangumiDetail.TYPE_CONTRACTED://承包
                ...
                if (EmptyUtils.isNotEmpty(beanList)) {
                    RequestOptions requestOptionsContracted = new RequestOptions()
                    ...
                    Stream.of(beanList).forEach(
                            listBean ->
                                    Glide.with(mContext)
                                            .load(listBean.face)
                                            .apply(requestOptionsContracted)
            ...
            case MulBangumiDetail.TYPE_COMMENT_HOT_ITEM://热门评论
                ...
                RequestOptions requestOptionsHotItem = new RequestOptions()
                        .placeholder(R.drawable.bili_default_avatar)
                        .centerCrop()
                        .diskCacheStrategy(DiskCacheStrategy.ALL)
                        .dontAnimate();
            ...
            case MulBangumiDetail.TYPE_COMMENT_NOMAL_ITEM://普通评论
                ...
                RequestOptions requestOptionsNormal = new RequestOptions()
                        .placeholder(R.drawable.bili_default_avatar)
                        .centerCrop()
                        .diskCacheStrategy(DiskCacheStrategy.ALL)
                        .dontAnimate();
